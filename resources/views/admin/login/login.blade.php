...
<div class="row login_main"
     style="background-image: {!! admin_setting('logobg') ? "url(" . \Illuminate\Support\Facades\URL::asset('storage/' . admin_setting('logobg')) . ")" : ''!!}">
    ...
    <div class="col-md-9 col-sm-9 col-12 auth-fluid-right">
        <div class="auth-user-testimonial">
            ...
            <p class="lead"><i class="mdi mdi-format-quote-open"></i>你如果出色地完成了某件事，那你应该再做一些其他的精彩事儿。不要在前一件事上徘徊太久，想想接下来该做什么...
